...
//    this.pneumaticscad=pneumaticscad;
  ...
  //System.out.println("element:"+ep.modelName);   
      ...
      m = new JMenuItem(Config.getString("popup.delete"));
      m.addActionListener(this);
      m.addMouseListener(new menuItemMouseAdapter());
      popup.add(m); 
      rotm = new JMenuItem(Config.getString("popup.rotate"));
      rotm.addActionListener(this);
      rotm.addMouseListener(new menuItemMouseAdapter());
      popup.add(rotm); 
      
      popup.addSeparator();
      m = new JMenuItem(Config.getString("popup.name"));
      m.addActionListener(this);
       m.addMouseListener(new menuItemMouseAdapter());
      popup.add(m); 
      grouped=false;
      angle=0.0;
//      BufferedImage buffer=new BufferedImage(imageDim.width,imageDim.height,BufferedImage.TYPE_INT_RGB);
...
*/
 ...
 //   String nameno=(String) nametable.get(modelType+"*"+modelName);
  ...
  public static int deltax=3,deltay=3;
...
//System.err.println(x+":"+y);
  ...
  public String write()
   {
    ...
    sb.append(Integer.toString(PneumaticsCAD.Data_Element)+" ");
    sb.append(modelType+" ");
    sb.append(modelName+" ");
  ...
  public static tw.com.justiot.pneumatics.pneumaticelement.PneumaticElement read(String str, PneumaticListener pneumaticscad) throws Exception
   { 
    ...
    if(dtype!=PneumaticsCAD.Data_Element) return null;
...
//System.out.println("Element instanceElement");     
    Object obj=Creater.instanceElement(mType,mName,pneumaticscad);
    if(obj==null) return null;
    if(!(obj instanceof tw.com.justiot.pneumatics.pneumaticelement.PneumaticElement)) return null;
...
//System.err.println("switchitem"+coms.length);
   ...
   private class rotateCommand extends Command
	...
	public rotateCommand(Object ele)
     {super("Element",ele,Command_rotate);
     }
    public void undo()
     {rotateBack();
     }
  ...
  private class changeNameCommand extends Command
	...
	public changeNameCommand(Object ele,String on,String nn)
     {super("Element",ele,Command_changeName);
      oldname=on;
      newname=nn;
     }
    public void undo()
