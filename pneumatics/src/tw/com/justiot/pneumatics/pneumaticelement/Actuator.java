package tw.com.justiot.pneumatics.pneumaticelement;
...
import tw.com.justiot.pneumatics.config.ActuatorParameter;
...
public class Actuator extends PneumaticElement
 {public static final int Command_setValvePos=1;
   ...
   {super(mname,true, pneumaticscad);
    if(PneumaticConfig.parameter.containsKey(mname))
     {ActuatorParameter ep=(ActuatorParameter) PneumaticConfig.parameter.get(mname);
      ...
      try
       {if(LSpressed==null)
         LSpressed=util.loadImage(modelType,modelName,"LSpressed",File.separator+"resources"+File.separator+"images"+File.separator+"SymSys"+File.separator+"LSpressed.GIF");
        if(LSrelease==null)
         LSrelease=util.loadImage(modelType,modelName,"LSrelease",File.separator+"resources"+File.separator+"images"+File.separator+"SymSys"+File.separator+"LSrelease.GIF");
        if(LSleft==null)
         LSleft=util.loadImage(modelType,modelName,"LSleft",File.separator+"resources"+File.separator+"images"+File.separator+"SymSys"+File.separator+"LSleft.GIF");
        if(LSlefty==null)
         LSlefty=util.loadImage(modelType,modelName,"LSlefty",File.separator+"resources"+File.separator+"images"+File.separator+"SymSys"+File.separator+"LSlefty.GIF");
        if(LSleftn==null)
         LSleftn=util.loadImage(modelType,modelName,"LSleftn",File.separator+"resources"+File.separator+"images"+File.separator+"SymSys"+File.separator+"LSleftn.GIF");
        if(LSright==null)
         LSright=util.loadImage(modelType,modelName,"LSright",File.separator+"resources"+File.separator+"images"+File.separator+"SymSys"+File.separator+"LSright.GIF");
        if(LSrighty==null)
         LSrighty=util.loadImage(modelType,modelName,"LSrighty",File.separator+"resources"+File.separator+"images"+File.separator+"SymSys"+File.separator+"LSrighty.GIF");
        if(LSrightn==null)
         LSrightn=util.loadImage(modelType,modelName,"LSrightn",File.separator+"resources"+File.separator+"images"+File.separator+"SymSys"+File.separator+"LSrightn.GIF");
       }
      catch (Exception e)
  ...
  //    ports[0].setQCapacity(0.0f);
   //   if(ports[1]!=null) ports[1].setQCapacity(0.0f);
...
/*
  private void setmotion() {
	...
	if(ports[1]!=null) ports[1].setFlowrate(Port.sourceFlowrate);
	float max=ports[0].getPressure();
	if(ports[1]!=null && ports[1].getPressure()>max) max=ports[1].getPressure();
	ports[0].setPressure(max);
	if(ports[1]!=null) ports[1].setPressure(max);
  }
  */
